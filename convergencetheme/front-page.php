 <?php get_header(); ?>
    ...
    <meta property="og:url" content="https://convergence.rmc.edu" />
    <meta property="og:type" content="website" />
    <meta property="og:site_name" content="Convergence" />
    <style type="text/css" media="all">
      .program-benefit {
        background: url(wp-content/themes/convergencetheme/assets/img/kids-learning_image.jpg) no-repeat center center fixed !important;
        background-size: cover !important;
        background-attachment: scroll !important;
        background-position: 0 0 !important;
      }
    </style>
    <link rel="canonical" href="https://convergence.rmc.edu" />
  </head>
  <body id="body" class="sub convergence.rmc.edu">
    ...
    <div class="page-wrap">
      <div class="row">
              ...
              <div class="row">
                <div class="container">
                  <section class="intro">
                    ...
                    <p>Where faith and science meet </p>
                  </section>
                </div>
                <!--container-->
              </div>
                      ...
                      <div class="program-txt">
                        ...
                        <div>
                          <div class="video-files">
                            <div>
                              <iframe title="Randolph-Macon College: Convergence 2018" src='https://player.vimeo.com/video/644001449' style="border-width: 0px;" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe>
                            </div>
                          </div>
                        </div>
                      </div>
          ...
          <div>
            <section class="program-benefit">
              <div class="row">
                <div class="container">
                  <div class="ribbon">
                    <img src="wp-content/themes/convergencetheme/assets/img/scholarship_banner.png" alt="Students who attend Convergence receive a $1000 scholarship to Randolph-Macon College" title="scholarship_banner" data-displaymode="Original" />
                  </div>
                  <article class="benefit-txt">
                    <h2>Program Highlights</h2>
                    <h3>LEARN, READ &amp;DISCUSS </h3>
                    <ul>
                      <li>Each year,&nbsp;Randolph-Macon College faculty from departments and programs, such as Religious Studies, Biology, Physics, Chemistry, Computer Science, and Environmental Studies give lectures, lead workshops, and direct group projects. Joined by esteemed friends of the College, they help you explore the origins of the cosmos, the beginnings of life, and the natural environment, as seen from different perspectives. Throughout the program you will explore the convergence of faith and science.</li>
                      <li>After each presentation, meet in a small group facilitated by a Randolph-Macon student to discuss and apply what you &rsquo;ve heard.</li>
                    </ul>
                    <h3> EXPLORE AS YOU LEARN <br />
                    </h3>
                    <ul>
                            ...
                            <div>
                              <div>
                                <div>
                                  ...
                                  <br /> Check in/Move in <br /> Campus tour <br /> Discussion: Intro to Faith and Science &nbsp; <br /> Movie &nbsp; <br /> Evening worship <br />
                                  <br />
                                  <strong>WEDNESDAY JULY 19</strong>
                                  <br /> Sophia Farms &nbsp; <br /> Discussion: Faith, Food &amp;Farming <br /> Creation Space &nbsp; <br /> Faculty Panel: Faith &amp;Science <br /> Religious Leaders Panel: Faith &amp;Science <br /> Fun Chemistry activity <br /> Evening worship <br />
                                  <br />
                                  <strong>THURSDAY JULY 20</strong>
                                  <br /> Shalom Farms &nbsp; <br /> Fitrah Farms <br /> Presentation: The Bible and Food <br /> Christian Music Skate Night &nbsp; <br /> Evening Worship <br />
                                  <br />
                                  <strong>FRIDAY JULY 21</strong>
                                  <br /> Small group reflection/creation space <br /> Callie Walker presents: Land Access and Justice &nbsp; <br /> Book discussion: The Theology of Soul Food by Adrian Miller <br /> Babylon MicroFarms <br /> Free time in Brock Rec Center <br /> Evening Worship <br />
                                  <br />
                                  <br />
                                  <strong>SATURDAY JULY 22</strong>
                                  <br /> Ashland Farmer &rsquo;s Market &nbsp; <br /> Cooking demonstration/lunch with Adrian Miller <br /> Adrian Miller: The Theology of Soul Food Lecture followed by Q &amp;A (parents and families invited) <br /> eSports arena tour and game time <br /> Evening Worship <br />
                                  <br />
        ...
        <div>
          <div>
            <section class="program-sponsor">
              <div class="row">
                <div class="container">
                  <div class="sponsor-txt">
                    <h2>Program Partners</h2>
                    <div class="sponsor-logos">
                      <img src="wp-content/themes/convergencetheme/assets/img/shalom-farms_logo.png" alt="Shalom Farms" title="shalom-farms_logo" data-displaymode="Original" />
                      <img src="wp-content/themes/convergencetheme/assets/img/duncan-memorial_logo.png" alt="Duncan Memorial United Methodist Church" title="duncan-memorial_logo" data-displaymode="Original" />
                      <img src="wp-content/themes/convergencetheme/assets/img/pat-watkins_logo.png" alt="Pat Watkins General Board of Global Ministries" title="pat-watkins_logo" data-displaymode="Original" />
                    </div>
                    <p class="centered">
                      <img src="wp-content/themes/convergencetheme/assets/img/lilly-endowment-logo.png?sfvrsn=e49ad600_0" alt="Lilly Endowment Inc" title="lilly-endowment-logo" data-displaymode="Original" />
                    </p>
                    <p class="centered">Funded by a generous grant from the Lilly Endowment.</p>
                  </div>
                </div>
                <!--container-->
              </div>
